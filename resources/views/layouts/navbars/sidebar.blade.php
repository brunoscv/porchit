<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-dark bg-default" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <img src="{{ asset('porchit') }}/img/brand/porchit-logo.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                        ...
                        <img alt="Image placeholder" src="{{ asset('porchit') }}/img/theme/team-1-800x800.jpg">
                        </span>
                    </div>
                </a>
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('porchit') }}/img/brand/blue.png">
                        </a>
                    </div>
